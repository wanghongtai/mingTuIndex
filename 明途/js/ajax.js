...
function reg() {
    ...
    $.ajax({
        ...
        type:'post',
        url:'http://localhost:8080/regInfo/saveItem',
...
$().ready(function(){
    ...
    $.ajax({
        type:'post',
        url:'http://localhost:8080/sysInfo/count',
        success:function(data){
            console.log(data);
            num=data;
            if(num>=0){
...
$.ajax({
        type:'post',
        url:'http://localhost:8080/sysInfo/todayCount',
        success:function(data){
            console.log(data);
            numCount=data;
...
$.ajax({
    type:'post',
    url:'http://localhost:8080/sysAcc/saveItem',
    success:function(data){
        console.log(data);
    },
    error:function(){
